...
Scenario: As User Create a new Congress
    ...
    And I fill in "accreditamenti_congressibundle_congressotype_data_inizio_day" with "01"
    And I fill in "accreditamenti_congressibundle_congressotype_data_fine" with "01 09 2012"
